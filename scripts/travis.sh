...
buildVersion=$(node -pe "require('$buildDir/projects/ngx-simple-http/package.json').version")
...
"lint-lib")
  ...
  ng lint ngx-simple-http
  ;;
"test-lib")
  echo -e "\x1b[34mTesting the library...\x1b[0m"
  ng test ngx-simple-http --watch=false
  ;;
"lint-demo")
  echo -e "\x1b[31m\x1b[1mNo demos! Exiting...\x1b[0m"
  exit 1
  ;;
"test-demo")
